        ...
        <div class="card mb-1">
            <div class="card-body px-0 pt-0 pb-0">
                <div class="d-flex justify-content-between px-4 pt-3">
                    <h6 class="border-bottom d-inline-block">
                        Rawat Jalan {{ $route.params.register }}
                    </h6>
                </div>
                            ...
                            <div class="col-md-4 col-lg-2">
                                <div class="mb-1">
                                    ...
                                    <input
                                        ...
                                        style="
                                            border: 3px solid rgb(214, 107, 107);
                                        "
                                        :disabled="true"
                                    />
                                </div>
            ...
            <div class="card-body">
                <router-view v-slot="{ Component }" :key="$route.fullPath">
                    <transition name="fade-x" mode="out-in">
                        <component :is="Component" ref="viewByRegRef" />
                    </transition>
                </router-view>
            </div>
        </div>
        ...
        show(params) {
            ...
            pasienService
                ...
                .then((resp) => {
                    ...
                    this.form.mr =
                        resp.data.data?.pasien?.MR ?? resp.data.data?.MR;
                    this.form.nama =
                        resp.data.data?.pasien?.NAMA ?? resp.data.data?.NAMA;
                    this.form.tgl_lahir =
                        resp.data.data?.pasien?.TGL_LAHIR ??
                        resp.data.data?.TGL_LAHIR;
                    this.form.alamat =
                        resp.data.data?.pasien?.ALAMAT ??
                        resp.data.data?.ALAMAT;
                    ...
                    if (this.$route.name === "ViewByReg") {
                        ...
                        this.$refs.viewByRegRef.filter.kunjungan =
                            this.form.tanggal;
                    }
